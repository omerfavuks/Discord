...
app.get('/', (req, res) => res.send('Subscribe to CoderFredi'))
...
client.once('ready', () => {
  ...
  client.user.setActivity(`... server`, { type: "LISTENING" }); // Set the bot's activity status
  ...
  if (config.command.notfound_message === true && !client.commands.has(command)) {
    return message.channel.send(
      new Discord.MessageEmbed()
        ...
        .setDescription(`üzgünüm  \`${command}\` böylebi komut yok!`)
